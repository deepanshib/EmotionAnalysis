package com.pavithirakc.emoTrack;
...
import com.pavithirakc.emoTrack.R;
import com.pavithirakc.emoTrack.TextToSpeechActivity;
import com.pavithirakc.emoTrack.helper.ImageHelper;
...
//        });
    ...
    public void selectImage(View view) {
        ...
        Intent intent;
        intent = new Intent(RecognizeActivity.this, com.pavithirakc.emoTrack.helper.SelectImageActivity.class);
        ...
        switch (requestCode) {
            case REQUEST_SELECT_IMAGE:
                if (resultCode == RESULT_OK) {
                    ...
                    mBitmap =  com.pavithirakc.emoTrack.helper.ImageHelper.loadSizeLimitedBitmapFromUri(
